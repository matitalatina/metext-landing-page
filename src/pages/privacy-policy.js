      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(${
            configs.cover_overlay_color_rgba_1
          },${configs.cover_overlay_color_rgba_2}),url(${
          ...
          <div className="container">
            ...
            <Content className="content">
              ...
              <div className="post-content">
                <p>
                  I am Mattia Natali, the data controller.{" "}
                  <a href="m&#97;il&#116;o&#58;ma&#116;t&#37;69anat%&#54;1l&#37;69de&#37;76&#64;gm&#97;il%2Ec&#111;m">
                    You can contact me
                  </a>{" "}
                ...
                <ul>
                  ...
                  <li>IP Address</li>
                  <li>
                    time spent and your behavior on my app. For example, how
                    many times you required image scanning.
                  </li>
                </ul>
                <p>when you&apos;re using my app.</p>
                ...
                <ul>
                  ...
                  <li>
                    have analytics and insights to check the performance of my
                    app.
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    ...
                    their services, including (without limitation) IT service
